...
open my $singleFilePush, '>', "$baseDir/concatFilterGroup/RemoveOne_$removeOneList[$index]_Group.fasta" or die "Cannot open $removeOneList[$index]_RemoveOneGroup.fasta: $!";
...
print $logRemoveOneFH "RemoveOne_$removeOneList[$index]_Group.fasta\n\n";
...
open my $singleFilePush, '>', "$baseDir/concatFilterGroup/KeepOne_$keepOneList[$indexTwo]_Group.fasta" or die "Cannot open $keepOneList[$indexTwo]_RemoveOneGroup.fasta: $!";
print $singleFilePush @finalArray;
close $singleFilePush;
...
print $logKeepOneFH "KeepOne_$keepOneList[$indexTwo]_Group.fasta\n\n\n";
