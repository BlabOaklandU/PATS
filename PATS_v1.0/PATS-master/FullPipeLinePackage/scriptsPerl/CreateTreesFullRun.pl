...
system("$fastaTreeMPPath/FastTreeMP -lg -log $baseDir/fastTree/removeOneFullReRun/RemoveOne_$removeOneList[$index]/fastTreeLog_$removeOneList[$index].txt $filename");
...
system("$fastaTreeMPPath/FastTreeMP -lg -log $baseDir/fastTree/keepOneFullReRun/KeepOne_$keepOneList[$index]/fastTreeLog_$keepOneList[$index].txt $filename");
...
system("$fastaTreeMPPath/FastTreeMP -lg -log $baseDir/fastTree/removeGroupFullReRun/fastTreeLog_RemoveGroup.txt $filename");
