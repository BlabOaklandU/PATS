...
This software comes with Muscle 3.8.31, ProteinoOrtho 6.0.18, FastTree 2.1.11, RAxML 8.2.12, and BLAST 2.10.1+  
...
By default, FastTree will only use the LG model  
